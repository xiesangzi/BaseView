...
public class BrushTextView extends AppCompatTextView {
    ...
    public BrushTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        BrushTextView.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }

    /**
     * Use this method to add a {@link Piece} to a BabushkaText.
     ...
     *
     * You create a Piece by using it's {@link  Piece.Builder}
     *
     */
